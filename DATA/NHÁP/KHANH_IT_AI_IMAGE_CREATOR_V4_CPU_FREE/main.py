...
APP_NAME = "KHÁNH IT - AI IMAGE CREATOR V4 CPU"
...
class App(ctk.CTk):
    ...
    def build_left(self):
        ...
        ctk.CTkLabel(
            left, text="AI IMAGE CREATOR V4 CPU",
    ...
    def load_model(self):
        try:
            ...
            self.after(0, lambda: self.load_failed(str(e)))
    ...
    def generate(self, prompt):
        try:
            ...
            self.after(0, lambda: self.generate_failed(str(e)))
